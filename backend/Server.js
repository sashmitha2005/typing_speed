...
mongoose.connect('mongodb+srv://shrisashmithas22aid:hello123@project.hfj8r.mongodb.net/typingApp?retryWrites=true&w=majority&appName=project', { useNewUrlParser: true, useUnifiedTopology: true })
  .then(async () => {
